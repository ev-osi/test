...
\hhline{~}
%row no:2
\multicolumn{1}{p{6.49in}}{\section*{\Centering {СОЗДАНИЕ ПОЛЬЗОВАИХ ФУНКЦИЙ В ПРИЛОЖЕНИИ EXCEL}}
} \\
\hhline{~}
%row no:3
\multicolumn{1}{p{6.49in}}{\subsubsection*{\Centering {по курсу: ИНФННЫЕ ТЕХНОЛОГИИ}}
} \\
\hhline{~}
%row no:4
...
\multicolumn{1}{p{1.0in}}{\Centering {51}} & 
\multicolumn{1}{p{-0.04in}}{} & 
\multicolumn{1}{p{1.63in}}{} & 
\multicolumn{1}{p{-0.04in}}{} & 
\multicolumn{1}{p{1.63in}}{\Centering {А.Ю. Анов}} \\
\hhline{~-~-~-}
%row no:2
